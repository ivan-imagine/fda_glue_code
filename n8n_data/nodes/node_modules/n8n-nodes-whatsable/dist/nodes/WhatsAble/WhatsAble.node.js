...
class WhatsAble {
            ...
            loadOptions: {
                ...
                async getProductOperations() {
                    ...
                    try {
                        ...
                        const response = await this.helpers.httpRequestWithAuthentication.call(this, 'whatsAbleApi', validationOptions);
                ...
                async getLabelsForUpdateContact() {
                    const returnData = [];
                    returnData.push({
                        name: 'Remove All',
                ...
                async getPhoneNumbers() {
                    ...
                    try {
                        ...
                        const response = await this.helpers.httpRequestWithAuthentication.call(this, 'whatsAbleApi', phoneNumbersOptions);
                        if (Array.isArray(response)) {
                ...
                async getGroups() {
                    ...
                    try {
                        const groupsOptions = {
                            method: 'GET',
                            baseURL: constants_1.WHATSABLE_DASHBOARD_BASE_DOMAIN,
                            url: `/api/groups/automation/groups`,
                            headers: {
                                'Accept': 'application/json',
                            },
                        };
                        const response = await this.helpers.httpRequestWithAuthentication.call(this, 'whatsAbleApi', groupsOptions);
    ...
    static buildConditionPayload(conditions) {
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            try {
                ...
                const enableConditions = this.getNodeParameter('enableConditions', i, false);
                let searchPayload = {};
                if (enableConditions) {
                    const conditionsData1 = this.getNodeParameter('conditions', i, { values: [] });
                    const conditionsData2 = this.getNodeParameter('conditions2', i, { values: [] });
                    ...
                    if (conditions1.length > 0) {
                        ...
                        if (payload1[0].length > 0 || payload1[1].length > 0) {
                            searchPayload.search2 = payload1;
                        }
                    }
                    if (conditions2.length > 0) {
                        ...
                        if (payload2[0].length > 0 || payload2[1].length > 0) {
                            searchPayload.search1 = payload2;
                        }
                    }
                }
                let response;
                if (operation === 'sendWhatsAppMessage') {
                    const productOperation = this.getNodeParameter('productOperation', i);
                    if (productOperation === 'sendMessage') {
                        ...
                        const phoneNumber = this.getNodeParameter('updateContactPhoneNumber', i);
                        const note = this.getNodeParameter('updateContactNote', i, '');
                        const labels = this.getNodeParameter('updateContactLabels', i, []);
                        const selectedRemoveLabels = this.getNodeParameter('selectRemoveLabels', i, []);
                        const requestBody = {
                        ...
                        if (!labels || labels.length === 0) {
                            ...
                            requestBody.labels = labels.filter((label) => label !== '__REMOVE_ALL__');
                        }
                        ...
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Product operation ${productOperation} is not supported`);
                    }
                }
                    ...
                    if (productOperation === 'sendNotifyerTemplate') {
                        ...
                        const messageType = this.getNodeParameter('messageType', i);
                        const labels = this.getNodeParameter('nonTemplateLabels', i, []);
                        const scheduledTime = this.getNodeParameter('nonTemplateScheduledDateTime', i);
                        const timezone = this.getNodeParameter('nonTemplateTimezone', i);
                        ...
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Product operation ${productOperation} is not supported for scheduling`);
                    }
                }
                else if (operation === 'sendWhatsAppMessageToGroup') {
                    const productOperation = this.getNodeParameter('productOperation', i);
                    if (productOperation === 'sendWhatsableGroupMessage') {
                        const groupData = this.getNodeParameter('whatsableGroup', i);
                        const message = this.getNodeParameter('whatsableGroupMessage', i);
                        ...
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Product operation ${productOperation} is not supported for group messages`);
                    }
                }
                else {
